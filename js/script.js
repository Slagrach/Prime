...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var scrollItems = document.querySelectorAll('.solution__list_bottom, .top__line, .top__img');
  var scrollAnimation = function scrollAnimation() {
    ...
    scrollItems.forEach(function (el) {
      ...
      if (windowCenter >= scrollOffset) {
        el.classList.add('_animate', '_animate2');
      } else {
        el.classList.remove('_animate', '_animate2');
      }
    });
  };
  var headerFixed = function headerFixed() {
    var scrollTop = window.scrollY;
    var heroCenter = hero.offsetHeight / 0;
